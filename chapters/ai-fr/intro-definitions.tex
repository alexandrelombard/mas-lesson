...
\begin{frame}[c]{Qu'est-ce que l'IA ?}
	\begin{definition}[axée sur la mimétisme comportemental par Minsky, années 50]
...
\sidecite{ElFallahSeghrouchni18}
\figureslide{{Différentes approches} pour l'IA}{ai_approaches-fr}

\sidecite{ElFallahSeghrouchni18}
\animatedfigureslide{{Les approches de l'IA} plus en détail}{ai_approaches_in_details}
